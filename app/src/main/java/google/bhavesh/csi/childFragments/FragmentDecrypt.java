 ...
 * Use the {@link FragmentDecrypt#newInstance} factory method to
...
public class FragmentDecrypt extends Fragment {
     ...
     * @return A new instance of fragment FragmentDecrypt.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_fragment_cozine, container, false);

        WebView myWebView = (WebView)v. findViewById(R.id.webview);
        WebSettings webSettings =myWebView.getSettings();
        webSettings.setJavaScriptEnabled(true);
        myWebView.loadUrl("http://decrypt.co.in/");
