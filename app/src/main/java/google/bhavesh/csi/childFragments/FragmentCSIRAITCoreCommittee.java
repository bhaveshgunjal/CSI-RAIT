 ...
 */
public class FragmentCSIRAITCoreCommittee extends Fragment {
    ...
    public FragmentCSIRAITCoreCommittee() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String url2 = "https://api.myjson.com/bins/52lon";//core committee
...
// Adding request to request queue
    ...
    public ArrayList<Committee> parseJsonResponse(JSONObject response) {
        ...
        try {
            ...
            if (response.has("Corecommittee")) {
                JSONArray arrayContacts = response.getJSONArray("Corecommittee");
