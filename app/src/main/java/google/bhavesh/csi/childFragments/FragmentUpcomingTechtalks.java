 ...
 * Use the {@link FragmentUpcomingTechtalks#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentUpcomingTechtalks extends Fragment {
    ...
    private TechtalkAdapter mTechtalkAdapter;
    Techtalk techmate;
    ArrayList<Techtalk> techmateArrayList = new ArrayList<>();
    ...
    public FragmentUpcomingTechtalks() {
    ...
    public static FragmentUpcomingTechtalks newInstance(String param1, String param2) {
        FragmentUpcomingTechtalks fragment = new FragmentUpcomingTechtalks();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String url = "https://api.myjson.com/bins/37rwb";//techtalks
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        mTechtalkAdapter.setListEvents(techmateArrayList);
                        pDialog.hide();
                    }
...
//
    ...
    public ArrayList<Techtalk> parseJsonResponse(JSONObject response) {
        if (response == null || response.length() == 0) {
            return null;
        }
        try {
            StringBuilder data = new StringBuilder();
            if (response.has("techtalks")) {
                JSONArray arrayContacts = response.getJSONArray("techtalks");
                for (int i = 0; i < arrayContacts.length(); i++) {
                    ...
                    String thumbnail=currentContact.getString("urlthumbnail");
//

                    data.append(name + description + date + thumbnail+"" + "\n");
                    Log.d(data.toString(), "");
                    techmate= new Techtalk();
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_upcoming_techtalks, container, false);
        ...
        mTechtalkAdapter = new TechtalkAdapter(getActivity());
        ...
        mTechtalkAdapter.SetOnItemClickListener(new TechtalkAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View v, int position) {
                Dialog dialog = new Dialog(getContext());
                dialog.setContentView(R.layout.dialogtechtalk);
                final ImageView imageView= (ImageView) dialog.findViewById(R.id.image);
                TextView tv = (TextView) dialog.findViewById(R.id.brief);
                TextView tv1 = (TextView) dialog.findViewById(R.id.name);
                Techtalk techmate1=techmateArrayList.get(position);
                String thumbnail=techmate1.getImage();
                switch(position){
                    case 0:
                      ...
                      //  imageView.setImageResource(Integer.parseInt(techmate1.getImage()));
                        tv1.setText(techmate1.getName());
                        tv.setText(techmate1.getDescription());
                        if(thumbnail!=null)
                        {
                            mImageLoader.get(thumbnail, new ImageLoader.ImageListener() {
                                @Override
