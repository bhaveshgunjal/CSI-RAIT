...
import google.bhavesh.csi.childFragments.FragmentUpcomingTechtalks;

public class FragmentTechtalks extends Fragment {
    ...
    class TechAdapter extends FragmentPagerAdapter {
        ...
        {
            switch (position){
                case 1: return new FragmentTechmate();
                case 0:return new FragmentUpcomingTechtalks();
